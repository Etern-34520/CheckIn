        ...
        <div class="question" rounded clickable onclick="questionMD5ToFormDataMap = new Map(); questionMD5ToOriginalFormDataMap = new Map();editQuestion('${question.md5}')">
            ...
            <div class="t2">
                <div class="questionChoices">
                    <c:forEach var="choice" items="${question.getChoices()}"><div class="questionChoice" <c:if test="${choice.correct}">correct</c:if> rounded><c:out value="${choice.getContent()}"/></div></c:forEach>
                </div>
            </div>
        </div>
    </c:forEach>
    <div class="addButtons">
        <button type="button" text style="font-size: 20px" onclick="questionMD5ToFormDataMap = new Map(); questionMD5ToOriginalFormDataMap = new Map();addQuestion()">+</button>
