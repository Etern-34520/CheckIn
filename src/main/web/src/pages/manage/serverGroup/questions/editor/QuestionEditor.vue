...
<template>
    <el-watermark :font="{color: 'rgba(128,128,128,0.01)', fontSize: 16}" :content="['',currentUserQQ]" :rotate="-45"
                  :zIndex="2000" :gap="[150,150]" style="height: 100%">
                                        ...
                                        <transition name="smooth-height" mode="out-in">
                                            ...
                                            <div v-else-if="ready"
                                                ...
                                                <transition name="smooth-height">
                                                    <div v-if="questionInfo.question.type === 'MultipleChoicesQuestion'"
                                                         class="smooth-height-base" key="multipleChoice">
                                                        <div>
                                                            <multiple-choices-editor-plugin :question-info="questionInfo"/>
                                                        </div>
                                                    </div>
                                                    <div v-else-if="questionInfo.question.type === 'QuestionGroup'"
                                                         class="smooth-height-base" key="questionGroup">
                                                        <div>
                                                ...
                                                <collapse style="margin-top: 48px;" expanded
                                                    ...
                                                    <template #title>
                                                        <div style="padding: 8px 16px;display: flex;flex-wrap: wrap">
                                                            ...
                                                            <div class="flex-blank-1"></div>
                                                            <el-text type="info">字数 {{
                                                                    questionInfo.question.explanation ? questionInfo.question.explanation.length : 0
                                                                }}
                                                            </el-text>
                                                        </div>
                                                    </template>
                                                    <template #content>
                                                        <el-input type="textarea" placeholder="解析"
