...
const reloadRelatedData = () => {
    ...
    Promise.all([
        ...
        new Promise((resolve) =>
            QuestionCache.getAllAsync(data.value.questionIds, true).then((questionInfos1) => {
                questionInfos.value = questionInfos1;
                resolve();
            }, (e) => {
                console.log(e);
                questionInfos.value = e.data.questions;
                resolve();
            })
        )
    ]).then(() => {
...
<template>
    <div style="display: flex;flex-direction: column;flex:1;height: 0" v-loading="showLoading">
        <transition name="blur-scale" mode="out-in">
            ...
            <div
                style="padding: 12px 16px 4px;display: flex;flex-direction: column;align-items: stretch;flex:1;height: 0"
                :key="data.id" v-else-if="data">
                <div
                    style="display: flex;flex-direction: row;align-items: center;margin-left: 4px;margin-bottom: 8px;flex-wrap: wrap">
                    ...
                    <el-scrollbar v-if="data.status === 'SUBMITTED' && data.result" style="max-height: 70px">
                        <div style="display: flex;flex-direction: row;align-items: stretch;height: 60px">
                            <div style="margin-right: 64px;display: flex;flex-direction: row;align-items: stretch">
                                <div
                                    style="width: 6px;max-width: 6px;min-width: 6px;border-radius: 3px;margin-right: 32px;"
                        ...
                        <transition :name="slideWay?'slide-left-to-right':'slide-right-to-left'">
                            ...
                            <el-scrollbar v-else style="min-width: 100%;">
                                <div style="display: flex;flex-direction: column;width:calc(100% - 4px)">
                                    <div
                                        style="display: flex;flex-direction: column;margin-right: 16px;margin-bottom: 16px;flex:1;min-width: 220px">
                                        <div
                                    ...
                                    <collapse v-if="data.result">
                                        <template #title>
                                            <div
                                                style="height: 100%;margin-left: 8px;display: flex;flex-direction: row;align-items: center">
                                    ...
                                    <div v-if="partitionNames && Object.keys(partitionNames).length > 0"
                                        ...
                                        <div class="panel-1" style="padding: 12px 16px;flex: 1;margin: 16px 4px 4px;">
                                            ...
                                            <div
                                                style="display: flex;flex-direction: row;flex-wrap: wrap;margin-top: 8px;">
                                    ...
                                    <div style="display:flex;flex-direction: column;margin: 32px -4px -4px;"
                                        ...
                                        <div
                                            ...
                                            <template v-if="questionInfo">
                                                ...
                                                <div class="panel-1"
                                                    ...
                                                    <el-watermark
                                                        ...
                                                        :rotate="-45" style="flex: 1"
                                                        :zIndex="2000" :gap="[50,50]">
                                                        <div style="padding: 8px 12px 12px;flex: 1">
                                                            <el-text>用户提交</el-text>
                                                            <div
                                                                style="display: flex;flex-direction: column;align-items:baseline;margin-top: 8px"
                                                                v-if="questionInfo.question.type === 'QuestionGroup'">
                                                                <div
                                                                    v-for="(answerDatum,index) of getDisplayAnswerData(questionInfo,data.answers[questionInfo.question.id])">
                                                                    <div
                                                            ...
                                                            <div
                                                                style="display: flex;flex-wrap: wrap;align-items:baseline;margin-top: 8px;"
                                                                v-else>
                                                                <el-tag
                                                                    v-for="(answerDatum,index) of getDisplayAnswerData(questionInfo,data.answers[questionInfo.question.id])"
                                                                    style="margin: 2px"
                                                            ...
                                                            <div
                                                                style="margin-top: 8px;display: flex;flex-direction: row">
                                                                <el-tag type="info" size="large"
                                            ...
                                            <div v-else class="panel-1"
                                                 style="place-self: stretch;flex: 1;height: 60px;display: flex;flex-direction: column;justify-content: center;">
                                                <el-text type="info">题目已删除</el-text>
                                            </div>
                                        </div>
                                    </div>
                                </div>
