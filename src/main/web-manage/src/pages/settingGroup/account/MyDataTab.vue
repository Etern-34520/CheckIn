...
import MyLikeQuestionsView from "@/pages/settingGroup/account/MyLikeQuestionsView.vue";
import MyDislikeQuestionsView from "@/pages/settingGroup/account/MyDislikeQuestionsView.vue";
import MyQuestionsView from "@/pages/settingGroup/account/MyQuestionsView.vue";
import router from "@/router/index.js";
import TabPane from "@/components/common/TabPane.vue";
import MyExamRecordsView from "@/pages/settingGroup/account/MyExamRecordsView.vue";
